...
<div id="contentbackground">
	<div id="content">
		<%
    		...
    		//ResultSet rs;
    		int i = st.executeUpdate("delete from services where serviceID=" + serviceID);
    		if (i > 0) {
        	//session.setAttribute("userid", user);
        %>
        	<p>Congratulations, your services has been removed successfully!</p>
        <%
       		// out.print("You have sucessfully registered! Click"+"<a href='index.jsp'>here</a> to log in.");
    		} else {
    	%>
        		<p>Error! Your service has not been removed!</p>
        <%
    		}
		%>
	</div>
